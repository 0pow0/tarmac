...
class PredatorPreyEnv(gym.Env):
    ...
    def multi_agent_init(self, args):
        ...
        self.vocab_size = 1 + 1 + self.BASE + 1 + 1 + 1
    ...
    def _get_cordinates(self):
        idx = np.random.choice(np.prod(self.dims),(self.npredator + self.nprey + 20), replace=False)
    ...
    def _get_obs(self):
        ...
        for i, p in enumerate(self.grid_loc):
            self.bool_base_grid[p[0] + self.vision, p[1] + self.vision, self.OBSTACLE_CLASS] += 1
